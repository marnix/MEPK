 ...
 * <p>
 * The basic building block is a {@link Statement}, representing statements like "for every
 ...
 * Then a {@link ProofStep} shows how to construct new statements from
 * existing statements: there are only a few built-in proof steps (substitute, compose, weaken)
 * and none can be added.
 * Finally a {@link Proof} represents a recipe for constructing one set of
 * statements for another using only ProofSteps.
 * <p>
 * The language of statements and their {@link Expression expressions} is that of Ghilbert,
 ...
 * statements: this is implemented in {@link Proof#verify()}.
